...
---
Are you lazy when writing long texts on your computer? Do you want to be able to transcribe or even translate (only into English though) everything locally, only using Python? You found the perfect article then, congrats.
...
This how it looks:
![TTRA]({{ site.baseurl }}/images/images_posts/2024_08_23_article_18_picture_1.png)
